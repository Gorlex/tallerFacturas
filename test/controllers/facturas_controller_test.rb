...
class FacturasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create factura" do
    assert_difference('Factura.count') do
      post facturas_url, params: { factura: { iva: @factura.iva, precio: @factura.precio, producto: @factura.producto } }, as: :json
    end
  ...
  test "should update factura" do
    patch factura_url(@factura), params: { factura: { iva: @factura.iva, precio: @factura.precio, producto: @factura.producto } }, as: :json
    assert_response 200
  end
